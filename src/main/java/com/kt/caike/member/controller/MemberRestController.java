...
@Api(tags = {"회원(Member) 정보 API Controller"})
@RestController
...
public class MemberRestController {
    ...
    @PostMapping
    public KtResponse<MemberDto> createMember(@Valid @ModelAttribute KtRequest<MemberDto> req, BindingResult bindingResult) {
    ...
    @GetMapping("/{id}")
    public KtResponse<MemberDto> findMember(@PathVariable("userId") String userId) {
